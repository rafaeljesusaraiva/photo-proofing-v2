...
export default function Help_PrivacyPolicy() {
  return (
    <>
      ...
      <p>
        A sua privacidade é importante para nós. É política do Provas Fotografia
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site <Link href="/">Provas Fotografia</Link>, e
      ...
      <p>
        ...
        <Link href="https://politicaprivacidade.com">
      ...
      <Typography component="h2" variant="h4">
        Política de Cookies Provas Fotografia
      </Typography>{" "}
      ...
      <p>
        ...
        informação que o Provas Fotografia oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          ...
          xenofóbica,{" "}
          <Link href="https://ondeapostar.pt/onde-da-a-bola/">
            Onde dá a Bola
          </Link>{" "}
        ...
        <li>
          ...
          (softwares) do Provas Fotografia, de seus fornecedores ou terceiros,
...
Help_PrivacyPolicy.getLayout = function getLayout(page: ReactElement) {
  return <Layout title="Política de Privacidade">{page}</Layout>;
};
